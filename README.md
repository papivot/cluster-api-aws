...
...
```
Once you are logged into the bastion host, you have to copy [scp or copy&paste] the above ssh key to the bastion host. Save it as a .pem file and set the access mode 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5OTY0ODQ4ODcsLTE3MDA1NTMyMzMsLT
